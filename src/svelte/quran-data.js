...
export const rtlLangs = ['ar', 'fa', 'ur', 'ps', 'ug', 'sd', 'ku', 'dv']

export function getPageNumber(aya) {
...
export function getSuraNumber(aya) {
...
export function getJuzNumber(aya) {
...
export function getHizbNumber(aya) {
